...
<template>
    <div class="container">
        ...
        <div class="form-group">
            ...
            <br>
            <button type="submit" class="btn btn-primary" id="btn" @click.prevent="PostDataAllReleaseTime">
                发送视频创作时间</button>
        </div>
        <hr>
        <!-- 视频评论上传 -->
        <div class="form-group">
            ...
            <br>
            <button type="submit" class="btn btn-primary" id="btn" @click.prevent="PostVideoCommentData">
                发送视频评论数据</button>
        </div>
    </div>
</template>
